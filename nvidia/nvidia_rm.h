...
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_NONE      0x00000000u
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_NMOS      0x00000001u
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_VGX       0x00000002u
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_HOST      0x00000003u
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_HOST_VGPU NV0080_CTRL_GPU_VIRTUALIZATION_MODE_HOST
#define NV0080_CTRL_GPU_VIRTUALIZATION_MODE_HOST_VSGA 0x00000004u

typedef struct {
	NvU32 virtualizationMode;
	NvU8  isGridBuild; /* NvBool; pad-compatible single byte */
	NvU8  _pad[3];
...
#define NV_OS32_ATTR_VIDMEM_4K_UNCACHED_BL_NONCONTIG \
	(NV_OS32_ATTR_VIDMEM_4K_UNCACHED_NONCONTIG | \
	 NV_OS32_DRF_SHL(16, 17, NVOS32_ATTR_FORMAT_BLOCK_LINEAR))
/* tick105: compose vidmem ATTR with explicit page-size selector (4K/BIG/HUGE) */
#define NV_OS32_ATTR_VIDMEM_UNCACHED_NONCONTIG_PGSZ(pgsz) \
	NV_OS32_ATTR_MAKE(NVOS32_ATTR_LOCATION_VIDMEM, (pgsz), \
			  NVOS32_ATTR_COHERENCY_UNCACHED, \
			  NVOS32_ATTR_PHYSICALITY_ALLOW_NONCONTIGUOUS)
#define NV_OS32_ATTR_VIDMEM_UNCACHED_BL_NONCONTIG_PGSZ(pgsz) \
	(NV_OS32_ATTR_VIDMEM_UNCACHED_NONCONTIG_PGSZ(pgsz) | \
	 NV_OS32_DRF_SHL(16, 17, NVOS32_ATTR_FORMAT_BLOCK_LINEAR))
/* tick111: sysmem WC non-contig with explicit page-size (guest/vGPU sema/rings) */
#define NV_OS32_ATTR_PCI_WC_NONCONTIG_PGSZ(pgsz) \
	NV_OS32_ATTR_MAKE(NVOS32_ATTR_LOCATION_PCI, (pgsz), \
			  NVOS32_ATTR_COHERENCY_WRITE_COMBINE, \
			  NVOS32_ATTR_PHYSICALITY_ALLOW_NONCONTIGUOUS)
#define NV_OS32_ATTR_PCI_UNCACHED_NONCONTIG_PGSZ(pgsz) \
	NV_OS32_ATTR_MAKE(NVOS32_ATTR_LOCATION_PCI, (pgsz), \
			  NVOS32_ATTR_COHERENCY_UNCACHED, \
			  NVOS32_ATTR_PHYSICALITY_ALLOW_NONCONTIGUOUS)
...
#define NV2080_CTRL_GR_INFO_INDEX_SHADER_PIPE_SUB_COUNT  0x00000009
